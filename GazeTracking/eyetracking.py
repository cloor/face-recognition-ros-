...
while True:
    ...
    for i in range(boxes.shape[0]):
        ...
        landmark = new_bbox.reprojectLandmark(landmark)   # size(68,2)
        point=[36, 37, 38, 39, 40, 41]
        print(landmark[point,0])
        left=(landmark[point][0][0],landmark[point][0][1])
        
        # frame = drawLandmark_multiple(frame, new_bbox, landmark)
